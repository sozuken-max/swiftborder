...
The file name is from an earlier as-is / to-be pass. Use this figure as the high-level drawing of the system in project `swiftborder`. Do not pair it with a second "target" architecture figure.
